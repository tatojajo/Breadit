...
export default function Home() {
  return <>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-y-4 md:gap-x-4 py-6">
      ...
      {/* subreddit info */}
      <div className="overflow-hidden h-fit rounded-lg border border-grey-200 order-first">
        ...
        <div className="-my-3 divide-y divide-grey-100 px-6 py4 text-sm leading-6">
